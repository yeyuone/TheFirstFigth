...
// 4、根据经纬度和关键字搜索商铺列表
export const reqShopsFromKey = (geohash,keyword) => ajax(`/search_shops`,{geohash,keyword})

// 5、获取一次性验证码
export const reqCaptcha = () => ajax('/captcha')

// 6、用户名密码登陆
export const reqLoginBypwd = (name,pwd,captcha) => ajax(`/login_pwd`,{name,pwd,captcha})
